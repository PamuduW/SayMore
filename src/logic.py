...
def generate_final_public_speaking_feedback(final_public_speaking_score):
    ...
    if final_public_speaking_score >= 90:
        return ("Outstanding public speaking performance! Your delivery is powerful, dynamic, and highly engaging, "
                "capturing your audience's attention effortlessly.")
    elif final_public_speaking_score >= 80:
        return ("Excellent performance! Your speaking skills and energy are well-honed, demonstrating strong vocal "
                "presence and effective engagement.")
    elif final_public_speaking_score >= 70:
        return ("Very good work! You have a solid public speaking foundation, though refining a few aspects of your "
                "vocal delivery and energy could elevate your impact even further.")
    elif final_public_speaking_score >= 60:
        return ("Good performance overall, but there is room for improvement. Focus on enhancing both your vocal "
                "dynamics and energy to create a more compelling and engaging presentation.")
    elif final_public_speaking_score >= 50:
        return ("Fair performance. With additional practice and attention to your vocal delivery and energy, "
                "you can significantly boost your public speaking effectiveness.")
    else:
        return ("Your public speaking performance needs improvement. Consider working on your vocal control, energy, "
