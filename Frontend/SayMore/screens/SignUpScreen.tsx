...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: 'bold', color: '#003366', marginBottom: 10, textAlign: 'center' },
  subtitle: { fontSize: 16, color: '#666', marginBottom: 30, textAlign: 'center' },
  inputContainer: { width: '100%', marginBottom: 20 },
  input: { backgroundColor: 'white', borderRadius: 10, padding: 15, marginBottom: 15, fontSize: 16, borderWidth: 1, borderColor: '#ddd', width: '100%' },
  button: { backgroundColor: '#87CEEB', borderRadius: 10, padding: 15, width: '100%', alignItems: 'center', marginBottom: 15 },
