  ...
  return (
    ...
    >
      ...
      <SafeAreaView style={styles.safeArea}>
        <Text style={[styles.header, { color: theme === 'dark' ? '#FFFFFF' : '#FFFFFF' }]}>
          Choose Points Category
        </Text>

        <TouchableOpacity
          style={[styles.optionButton, { backgroundColor: theme === 'dark' ? '#3A3A3A' : '#FFFFFF' }]}
          onPress={() => handlePress('Lessons Points')}
        >
          <Text style={[styles.optionText, { color: theme === 'dark' ? '#FFFFFF' : '#2A2D57' }]}>
            Lessons Points
          </Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  safeArea: { flex: 1, width: '100%', alignItems: 'center', justifyContent: 'center', paddingHorizontal: 20 },
