        ...
        <LinearGradient
          ...
          <ScrollView contentContainerStyle={styles.scrollContent}>
            <Text style={[styles.text, theme === 'dark' && styles.darkText]}>
              ...
              your data:
              {'\n\n'}
              1. <Text style={[styles.boldText, theme === 'dark' && styles.darkBoldText]}>Personal Info:</Text> We gather
              only basic details like your name & email to personalize your
              progress.
              {'\n\n'}
              2. <Text style={[styles.boldText, theme === 'dark' && styles.darkBoldText]}>Audio Storage:</Text> Any speech
              recordings remain securely stored and are used exclusively for
              analysis and feedback.
              {'\n\n'}
              3. <Text style={[styles.boldText, theme === 'dark' && styles.darkBoldText]}>Cookies Usage:</Text> We utilize
              cookies to ensure app performance & enhance your user experience.
              You can disable them anytime via device settings.
              {'\n\n'}
              4. <Text style={[styles.boldText, theme === 'dark' && styles.darkBoldText]}>Data Sharing:</Text> We never
              share or sell your personal data to third parties.
              {'\n\n'}
              5. <Text style={[styles.boldText, theme === 'dark' && styles.darkBoldText]}>Security Measures:</Text> Your
