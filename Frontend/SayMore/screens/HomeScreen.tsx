...
const styles = StyleSheet.create({
  ...
  testContainer: {
    marginTop: 40, alignItems: 'center', backgroundColor: '#FFFFFF', borderRadius: 20, padding: 20,
  ...
  optionButton: { flex: 1, backgroundColor: '#87CEEB', borderRadius: 10, padding: 15, alignItems: 'center', marginHorizontal: 10 },
