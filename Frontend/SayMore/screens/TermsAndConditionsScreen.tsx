        ...
        <View style={styles.contentWrapper}>
          ...
          <ScrollView
            ...
            <Text style={[styles.text, theme === 'dark' && styles.darkText]}>
              ...
              {'\n\n'}
              1. <Text style={[styles.boldText, theme === 'dark' && styles.darkBoldText]}>Account Information:</Text> Provide
              accurate and truthful personal information during registration and
              ensure your account remains secure.
              {'\n\n'}
              2. <Text style={[styles.boldText, theme === 'dark' && styles.darkBoldText]}>App Usage:</Text> Use the app
              solely for personal speech improvement and not as a substitute for
              professional therapy, diagnosis, or advice.
              {'\n\n'}
              3. <Text style={[styles.boldText, theme === 'dark' && styles.darkBoldText]}>Data Usage:</Text> Allow secure
              ...
              {'\n\n'}
              4. <Text style={[styles.boldText, theme === 'dark' && styles.darkBoldText]}>Prohibited Actions:</Text> Refrain
