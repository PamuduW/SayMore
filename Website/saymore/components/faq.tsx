      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Accordion type="single" collapsible>
          ...
          <AccordionItem value="item-4">
            ...
            <AccordionContent>
              Yes, SayMore provides personalized feedback based on your speech recordings. After each
              practice session, the app analyzes your speech and provides insights into areas where you
              can improve, helping you to focus on specific aspects of your speech.
            </AccordionContent>
          </AccordionItem>
