  ...
  return (
    <div className={cn("sticky top-40", className)}>
      <div>
        ...
        <p className="text-xs md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto pb-52">
          {description ||
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-16">
          <div className="text-center mx-24">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-50">Record Your Speech</h3>
          ...
          <div className="text-center mx-24">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-50">Get AI Analysis</h3>
            <p className="text-gray-200">
          ...
          <div className="text-center mx-24">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-50">Practice & Improve</h3>
            <p className="text-gray-200">
      ...
      <svg
        ...
        className=" absolute -top-100  md:-top-64 w-full">
        <motion.path
